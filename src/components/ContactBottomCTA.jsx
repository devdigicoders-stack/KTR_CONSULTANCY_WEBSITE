      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-6 xl:px-8">
        ...
        <div className="bg-[#020d1c] rounded-xl p-6 md:p-8 flex flex-col xl:flex-row items-center justify-between gap-6 xl:gap-8 shadow-xl border border-gray-800/60 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full xl:w-auto relative z-10 flex-shrink-0">
            {/* Call Now Button */}
            <button className="w-full sm:w-auto bg-[#de9e48] hover:bg-[#c98e41] text-white font-bold text-[13.5px] lg:text-[14px] px-6 lg:px-7 py-3 rounded transition-colors flex items-center justify-center shadow-md whitespace-nowrap">
            ...
            {/* WhatsApp Button */}
            <button className="w-full sm:w-auto bg-transparent hover:bg-white/5 border border-gray-600 text-white font-medium text-[13.5px] lg:text-[14px] px-6 lg:px-7 py-3 rounded transition-colors flex items-center justify-center whitespace-nowrap">
