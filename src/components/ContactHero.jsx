  ...
  return (
    <div className="bg-white relative">
      ...
      <div className="relative z-20 w-full border-t border-gray-100 bg-white shadow-[0_-5px_15px_rgba(0,0,0,0.02)]">
         <div className="max-w-[1400px] mx-auto px-4 lg:px-6 xl:px-8">
            <div className="flex flex-col lg:flex-row items-center justify-between py-6 gap-6 lg:gap-0">
               
               {/* 1. Call Us */}
               <div className="flex items-center gap-4 w-full lg:w-1/4 px-2 lg:px-4">
                 ...
                 <div>
                   ...
                   <p className="text-gray-600 text-[13px] font-medium mt-0.5">+91 12345 67890</p>
                 </div>
               </div>
               ...
               <div className="flex items-center gap-4 w-full lg:w-1/4 px-2 lg:px-4">
                 ...
                 <div>
                   ...
                   <p className="text-gray-600 text-[13px] font-medium mt-0.5">info@ktrconsultants.com</p>
                 </div>
               </div>
               ...
               <div className="flex items-center gap-4 w-full lg:w-1/4 px-2 lg:px-4">
                 ...
                 <div>
                   ...
                   <p className="text-gray-600 text-[12px] font-medium leading-tight mt-0.5">
