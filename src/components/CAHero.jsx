      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-6 xl:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8 xl:gap-16">
          ...
          <div className="w-full lg:w-[50%] xl:w-[55%] flex flex-col justify-center relative z-10">
            ...
            {/* Features */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-nowrap justify-between items-start lg:items-center gap-5 sm:gap-4 lg:gap-2 mt-8 lg:mt-6 w-full">
              ...
              <div className="flex items-center gap-3 lg:gap-2.5">
                ...
                <p className="text-[#020d1c] font-bold text-[13.5px] xl:text-[14.5px] leading-[1.3] whitespace-normal lg:whitespace-nowrap">Expert CA<br className="hidden lg:block"/> Professionals</p>
              </div>
              ...
              <div className="flex items-center gap-3 lg:gap-2.5">
                ...
                <p className="text-[#020d1c] font-bold text-[13.5px] xl:text-[14.5px] leading-[1.3] whitespace-normal lg:whitespace-nowrap">100% Compliance<br className="hidden lg:block"/> & Confidential</p>
              </div>
              ...
              <div className="flex items-center gap-3 lg:gap-2.5">
                ...
                <p className="text-[#020d1c] font-bold text-[13.5px] xl:text-[14.5px] leading-[1.3] whitespace-normal lg:whitespace-nowrap">Loan & Business<br className="hidden lg:block"/> Finance Focused</p>
              </div>
              ...
              <div className="flex items-center gap-3 lg:gap-2.5">
                ...
                <p className="text-[#020d1c] font-bold text-[13.5px] xl:text-[14.5px] leading-[1.3] whitespace-normal lg:whitespace-nowrap">Timely Support &<br className="hidden lg:block"/> End-to-End Assistance</p>
              </div>
