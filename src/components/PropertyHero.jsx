        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="w-full lg:w-[50%] xl:w-[45%]">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <button className="w-full sm:w-auto bg-white hover:bg-gray-50 border border-gray-300 text-[#020d1c] font-bold text-[14.5px] px-7 py-3.5 rounded-md transition-colors flex items-center justify-center shadow-sm whitespace-nowrap">
