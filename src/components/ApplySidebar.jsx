    ...
    <>
      ...
      <div className="bg-[#fdfaf5] border border-[#de9e48]/20 rounded-xl p-6">
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <a href="tel:+919918699696" className="text-[14px] font-bold text-[#020d1c] hover:text-[#de9e48] transition-colors">+91 99186 99696</a>
        </div>
        ...
        <a 
          ...
          className="w-full bg-transparent hover:bg-white border border-[#de9e48] text-[#de9e48] hover:text-[#c98e41] font-bold text-[13px] py-2.5 rounded transition-colors flex items-center justify-center gap-2"
        >
