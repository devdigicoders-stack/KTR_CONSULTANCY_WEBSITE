        ...
        <div className="bg-white rounded-2xl p-6 lg:p-10 xl:p-10 flex flex-col xl:flex-row gap-8 xl:gap-6 items-stretch">
          ...
          <div className="flex-[4] lg:pr-6">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between w-full relative">
              ...
              {steps.map((step, idx) => (
                <div key={idx} className="flex-1 flex flex-col items-center text-center relative group px-1 mb-12 lg:mb-0">
                  ...
                  {idx < steps.length - 1 && (
                    <>
                      ...
                      <div className="hidden lg:block absolute top-[26px] left-[calc(50%+30px)] w-[calc(100%-60px)] z-0 pointer-events-none">
