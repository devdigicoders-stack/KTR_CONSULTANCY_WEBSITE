    ...
    <section className="bg-white py-12">
      <div className="max-w-[1400px] mx-auto px-4 lg:px-6 xl:px-8 mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
          ...
          {/* Card 1: Court Name */}
          <div className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-[0_4px_15px_-5px_rgba(0,0,0,0.05)] hover:border-[#de9e48]/50 transition-colors">
            <svg className="w-8 h-8 text-[#de9e48] mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <span className="text-[#020d1c] font-bold text-[14px]">Court Name</span>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-[0_4px_15px_-5px_rgba(0,0,0,0.05)] hover:border-[#de9e48]/50 transition-colors">
            ...
            <span className="text-[#020d1c] font-bold text-[14px]">Date</span>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-[0_4px_15px_-5px_rgba(0,0,0,0.05)] hover:border-[#de9e48]/50 transition-colors">
            ...
            <span className="text-[#020d1c] font-bold text-[14px]">Bahi No.</span>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-[0_4px_15px_-5px_rgba(0,0,0,0.05)] hover:border-[#de9e48]/50 transition-colors">
            ...
            <span className="text-[#020d1c] font-bold text-[14px]">Jild No.</span>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-[0_4px_15px_-5px_rgba(0,0,0,0.05)] hover:border-[#de9e48]/50 transition-colors">
            ...
            <span className="text-[#020d1c] font-bold text-[14px]">Page No.</span>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-[0_4px_15px_-5px_rgba(0,0,0,0.05)] hover:border-[#de9e48]/50 transition-colors">
            ...
            <span className="text-[#020d1c] font-bold text-[14px]">Kramank No.</span>
          </div>
        </div>
