    ...
    <section className="relative bg-[#fcfcfd] pt-12 pb-16 lg:pt-16 lg:pb-20 font-sans overflow-hidden min-h-[600px] flex items-center">
      ...
      <div className="max-w-[1400px] w-full mx-auto px-4 lg:px-6 xl:px-12 relative z-10 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-[55%] xl:w-[60%] pt-4 lg:pt-0 z-20 lg:pr-8">
          ...
          <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold text-[#020d1c] leading-[1.15] mb-5 font-serif">
            Complete Financial Solutions <br className="hidden md:block" />
            for Your <span className="text-[#de9e48]">Business & Property</span>
          </h1>
          ...
          {/* Primary Buttons Row */}
          <div className="flex flex-col sm:flex-row flex-wrap items-center gap-3 lg:gap-4 mb-6">
            {/* Apply Online */}
            <Link 
              to="/apply-online" 
              className="w-full sm:w-auto inline-flex items-center justify-center bg-[#020d1c] hover:bg-[#0a1930] text-white font-bold py-3.5 sm:py-3 px-6 rounded-lg transition-all duration-300 shadow-md hover:-translate-y-0.5 text-sm whitespace-nowrap gap-1.5"
            >
              Apply Online
            ...
            <a 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#128C7E] border border-[#25D366]/30 font-bold py-3 sm:py-2.5 px-4 rounded-lg transition-all duration-300 text-sm whitespace-nowrap gap-1.5"
            >
          ...
          {/* Dedicated Check CIBIL Button (Directly Below Consultation) */}
          <div className="mb-10 flex flex-col sm:flex-row items-center gap-3">
            <Link 
              to="/cibil-services" 
              className="w-full sm:w-auto inline-flex items-center justify-center bg-[#de9e48] hover:bg-[#c98e41] text-[#020d1c] font-black py-3 px-6 rounded-lg transition-all duration-300 shadow-[0_4px_18px_rgba(222,158,72,0.4)] hover:shadow-[0_6px_24px_rgba(222,158,72,0.6)] hover:-translate-y-0.5 text-sm whitespace-nowrap gap-2 group cursor-pointer"
            >
              <svg className="w-4 h-4 text-[#020d1c]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
              <span>Check CIBIL</span>
              <span className="text-[11px] bg-[#020d1c] text-[#de9e48] px-2 py-0.5 rounded font-bold uppercase tracking-wider ml-1">
                Flat25 (25% OFF)
              </span>
          ...
          {/* Features Row */}
          <div className="grid grid-cols-2 lg:flex lg:flex-wrap lg:items-center gap-4 lg:gap-5 xl:gap-6">
            {/* Feature 1 */}
        ...
        <div className="w-full lg:w-[50%] xl:w-[45%] relative mt-12 lg:mt-0 flex justify-center items-center z-10 pointer-events-none px-4 lg:px-0 lg:-ml-16 xl:-ml-24 2xl:-ml-32 lg:pr-12 xl:pr-24">
          <img 
            src="/hero.png" 
      ...
      <div className="hidden lg:flex flex-col bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-gray-100 absolute right-4 xl:right-6 top-1/2 -translate-y-1/2 z-40 py-5 px-3 gap-6">
        ...
        <Link to="/cibil-services" className="flex flex-col items-center gap-1.5 group">
          <div className="text-[#de9e48] group-hover:-translate-y-0.5 transition-transform duration-300">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
          </div>
          <span className="text-[10px] font-semibold text-gray-700 group-hover:text-[#de9e48] transition-colors whitespace-nowrap">Check CIBIL</span>
        </Link>
