      ...
      <div className="max-w-[1400px] w-full mx-auto px-4 lg:px-6 xl:px-12 relative z-10 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-[55%] xl:w-[60%] pt-4 lg:pt-0 z-20 lg:pr-8">
          ...
          <div className="flex flex-wrap items-center gap-3 lg:gap-4 mb-12">
            ...
            <a href="https://wa.me/919918699696" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center bg-[#020d1c] hover:bg-[#0a1930] text-white font-bold py-3 px-6 rounded-md transition-all duration-300 shadow-md hover:-translate-y-0.5 text-sm whitespace-nowrap">
