    ...
    <section className="relative bg-[#fcfcfd] pt-12 pb-16 lg:pt-16 lg:pb-20 font-sans overflow-hidden min-h-[600px] flex items-center">
      ...
      <div className="max-w-[1400px] w-full mx-auto px-4 lg:px-6 xl:px-12 relative z-10 flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="w-full lg:w-[55%] xl:w-[60%] pt-4 lg:pt-0 z-20 lg:pr-8">
          ...
          {/* Primary Buttons Row */}
          <div className="flex flex-wrap items-center gap-3 lg:gap-4 mb-5">
            {/* Apply Online */}
            <Link 
              to="/apply-online" 
              className="inline-flex items-center justify-center bg-[#020d1c] hover:bg-[#0a1930] text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 shadow-md hover:-translate-y-0.5 text-sm whitespace-nowrap gap-1.5"
            >
              Apply Online
            ...
            <Link 
              to="/contact" 
              className="inline-flex items-center justify-center border-2 border-[#de9e48] text-[#020d1c] hover:bg-orange-50 font-bold py-2.5 px-5 rounded-lg transition-all duration-300 text-sm whitespace-nowrap"
            >
            ...
            <a 
              ...
              className="inline-flex items-center justify-center bg-[#25D366]/10 hover:bg-[#25D366]/20 text-[#128C7E] border border-[#25D366]/30 font-bold py-2.5 px-4 rounded-lg transition-all duration-300 text-sm whitespace-nowrap gap-1.5"
            >
          ...
          <div className="mb-10 flex flex-wrap items-center gap-3">
            <Link 
              to="/cibil-services" 
              className="inline-flex items-center justify-center bg-[#de9e48] hover:bg-[#c98e41] text-[#020d1c] font-black py-3 px-6 rounded-lg transition-all duration-300 shadow-[0_4px_18px_rgba(222,158,72,0.4)] hover:shadow-[0_6px_24px_rgba(222,158,72,0.6)] hover:-translate-y-0.5 text-sm whitespace-nowrap gap-2 group cursor-pointer"
            >
