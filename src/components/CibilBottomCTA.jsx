      ...
      <div className="max-w-[1400px] mx-auto px-4 lg:px-6 xl:px-8">
        ...
        <div className="bg-[#020d1c] rounded-2xl p-8 lg:p-10 xl:px-12 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-xl border border-gray-800/60">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
            {/* Consultation Button */}
            <button className="w-full sm:w-auto bg-[#de9e48] hover:bg-[#c98e41] text-white font-semibold text-[14.5px] px-8 py-3.5 rounded-md transition-colors flex items-center justify-center shadow-md whitespace-nowrap">
            ...
            {/* WhatsApp Button */}
            <button className="w-full sm:w-auto bg-transparent hover:bg-white/5 border border-gray-600 text-white font-medium text-[14.5px] px-8 py-3.5 rounded-md transition-colors flex items-center justify-center whitespace-nowrap">
