              ...
              <div className="bg-[#020d1c] text-white rounded-2xl p-6 sm:p-7 shadow-2xl border border-[#de9e48]/50 relative overflow-hidden animate-fadeIn">
                ...
                {apiResult.status === 'success' ? (
                  <>
                    ...
                    <div className="mt-5 bg-gradient-to-br from-[#0c1a2e] to-[#06101d] border border-[#de9e48]/40 rounded-2xl p-4 sm:p-5 shadow-lg text-left">
                      <div className="flex items-start gap-3">
                        <div className="w-10 h-10 rounded-xl bg-[#de9e48]/15 text-[#de9e48] border border-[#de9e48]/30 flex items-center justify-center flex-shrink-0 shadow-md">
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap mb-1">
                            ...
                            <span className="bg-[#de9e48]/20 text-[#de9e48] text-[9.5px] font-bold px-2 py-0.5 rounded-full border border-[#de9e48]/40">
                              Dispute & Advisory Support
                            </span>
                          </div>
                          <p className="text-[11.5px] text-gray-300 leading-relaxed mb-3">
                          ...
                          <div className="space-y-2">
                            <Link
                              ...
                              className="w-full inline-flex items-center justify-between bg-[#de9e48] hover:bg-[#c98e41] text-[#020d1c] font-black text-xs px-3.5 py-2.5 rounded-xl shadow-sm transition-all active:scale-95"
                            >
                            ...
                            <div className="flex items-center gap-2 flex-wrap pt-1">
                              <Link
                                to="/contact"
                                className="inline-flex items-center gap-1.5 bg-white/10 hover:bg-white/20 text-white font-bold text-xs px-3 py-2 rounded-lg border border-gray-700 transition-all shadow-sm active:scale-95"
                              >
                              ...
                              <a
                                href="https://wa.me/919918699696?text=Hi%20KTR%20Consultants%2C%20I%20have%20an%20inquiry%20regarding%20my%20generated%20credit%20report%20discrepancies."
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-1.5 bg-[#25D366]/15 hover:bg-[#25D366]/25 text-[#25D366] font-bold text-xs px-3 py-2 rounded-lg border border-[#25D366]/40 transition-all active:scale-95"
                              >
                            ...
                            <a
                              ...
                              className="inline-flex items-center text-xs font-semibold text-gray-300 hover:text-[#de9e48] transition-colors py-1 px-1"
                            >
                              📞 +91 99186 99696
                            </a>
                          </div>
                  ...
                  <>
                    ...
                    {/* Support & Dispute Assistance Card */}
                    <div className="mt-4 bg-gradient-to-br from-[#0c1a2e] to-[#06101d] border border-[#de9e48]/40 rounded-2xl p-4 shadow-lg text-left">
                      <div className="flex items-start gap-3">
                        <div className="w-9 h-9 rounded-xl bg-[#de9e48]/15 text-[#de9e48] border border-[#de9e48]/30 flex items-center justify-center flex-shrink-0 shadow-md">
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                          </svg>
                        </div>
                        <div className="flex-1 min-w-0">
                          <h4 className="text-xs font-bold text-white mb-1">
                            Facing Inaccuracies or Bureau Generation Issues?
                          </h4>
                          <p className="text-[11px] text-gray-300 leading-relaxed mb-2.5">
                            If you have active loans not reflected or notice discrepancies in your bureau record, contact our credit advisory specialists for immediate dispute resolution.
                          </p>
                          <div className="flex items-center gap-2 flex-wrap">
                            <Link
                              to="/contact"
                              className="inline-flex items-center gap-1.5 bg-[#de9e48] hover:bg-[#c98e41] text-[#020d1c] font-black text-[11px] px-3 py-1.5 rounded-lg shadow-sm transition-all"
                            >
                              <span>Write to Us →</span>
                            </Link>
                            <a
                              href="https://wa.me/919918699696?text=Hi%20KTR%20Consultants%2C%20I%20have%20an%20inquiry%20regarding%20my%20credit%20report%20record."
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center gap-1 bg-[#25D366]/15 hover:bg-[#25D366]/25 text-[#25D366] font-bold text-[11px] px-2.5 py-1.5 rounded-lg border border-[#25D366]/40 transition-all"
                            >
                              WhatsApp
                            </a>
                            <a
                              href="tel:+919918699696"
                              className="text-[11px] font-semibold text-gray-300 hover:text-[#de9e48] transition-colors py-1 px-1"
                            >
                              📞 +91 99186 99696
                            </a>
                          </div>
